...
export const translations = {
  en: {
    ...
    legend: {
      ...
      high: 'High',
      extreme: 'Extreme',
      wb0: 'No water deficit',
      wb1: 'Slight water deficit',
      wb2: 'Moderate water deficit',
      wb3: 'Water deficit',
      wb4: 'Quite large water deficit',
      wb5: 'Large water deficit',
      wb6: 'Severe deficit',
      nodata: 'No data',
    },
    overlay: {
  ...
  th: {
    ...
    legend: {
      ...
      extreme: 'เสี่ยงมาก',
      wb0: 'ไม่ขาดดุลน้ำ',
      wb1: 'ขาดดุลน้ำเล็กน้อย',
      wb2: 'ขาดดุลน้ำปานกลาง',
      wb3: 'ขาดดุลน้ำ',
      wb4: 'ขาดดุลน้ำค่อนข้างมาก',
      wb5: 'ขาดดุลน้ำมาก',
      wb6: 'ขาดดุลน้ำรุนแรง',
      nodata: 'ไม่มีข้อมูล',
    },
