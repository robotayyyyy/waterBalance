            ...
            <ul style={{ listStyle: 'none', margin: 0, padding: 0 }}>
              {amphoeList.map(a => (
                <li
                  ...
                  style={{
                    padding: '5px 12px', borderBottom: '1px solid #f1f5f9', cursor: 'pointer', fontSize: 12,
                    background: selectedAmphoe === a.id ? '#eff6ff' : 'transparent',
                    color: selectedAmphoe === a.id ? '#1d4ed8' : '#475569',
                    fontWeight: selectedAmphoe === a.id ? 600 : 400,
                  }}
                >
              ...
              <>
                ...
                <ul style={{ listStyle: 'none', margin: 0, padding: 0 }}>
                  {tambolList.map(t => (
                    <li
                      key={t.id}
                      onClick={() => onSelectTambol(t.id)}
                      style={{
                        padding: '5px 12px', borderBottom: '1px solid #f1f5f9', cursor: 'pointer', fontSize: 12,
                        background: selectedTambol === t.id ? '#fefce8' : 'transparent',
                        color: selectedTambol === t.id ? '#b45309' : '#475569',
                        fontWeight: selectedTambol === t.id ? 600 : 400,
                      }}
                    >
